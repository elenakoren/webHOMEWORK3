// Необходимо создать html-страницу с названием 1.html, в которой подключить файл 1.js (его тоже 
//необходимо создать рядом с html-файлом).
...
let tempС = prompt("Какая температура?");
let tempF = (9/5)*tempС+32
alert(`Цельсий:${tempС}, Фаренгейт:${tempF.toPrecision(3)}`);
